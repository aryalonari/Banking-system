...
class BankingSystem:
    def __init__(self, root):
        ...
        self.button_font = ("Helvetica", 24, "bold")
        self.button_bg = "#4CAF50"
        self.button_fg = "#ffffff"

        # Widgets for account creation
        self.create_account_frame = tk.Frame(root, bg="#f0f0f0")
        self.create_account_frame.pack(pady=10, padx=10, fill="both", expand=True)

        self.acc_num_label = tk.Label(self.create_account_frame, text="Account Number:", font=self.label_font, bg="#f0f0f0")
        ...
        self.acc_holder_label = tk.Label(self.create_account_frame, text="Account Holder:", font=self.label_font, bg="#f0f0f0")
        ...
        self.initial_balance_label = tk.Label(self.create_account_frame, text="Initial Balance:", font=self.label_font, bg="#f0f0f0")
        ...
        self.transaction_frame.pack(pady=10, padx=10, fill="both", expand=True)

        self.trans_acc_num_label = tk.Label(self.transaction_frame, text="Account Number:", font=self.label_font, bg="#f0f0f0")
        ...
        self.amount_label = tk.Label(self.transaction_frame, text="Amount:", font=self.label_font, bg="#f0f0f0")
        ...
        self.info_acc_num_label = tk.Label(self.info_frame, text="Account Number:", font=self.label_font, bg="#f0f0f0")
